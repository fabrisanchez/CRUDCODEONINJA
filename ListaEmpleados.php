        ...
        <?php
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                    ...
                    echo "<tr>
                        ...
                        <td>";
                            // read one record
                            echo "<a href='leerUnRegistro.php?id={$id}' class='btn btn-info m-r-1em'>Leer Un Registro</a>";
                 
                            // we will use this links on next part of this post
                            echo "<a href='update.php?id={$id}'  class='btn btn-primary m-r-1em'>Editar Registo</a>";
